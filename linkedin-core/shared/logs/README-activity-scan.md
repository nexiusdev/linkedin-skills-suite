...
- `linkedin-core/shared/logs/activity-scan-results-template.csv`: input + output table for activity review.
- `linkedin-core/shared/scripts/open-linkedin-profiles.ps1`: opens profile activity pages from the CSV.
...
2. Run `linkedin-core/shared/scripts/open-linkedin-profiles.ps1`.
