...
# Opens recent activity pages for prospects listed in linkedin-core/shared/logs/activity-scan-results-template.csv
...
if (-not (Test-Path $csvPath)) {
    ...
    Write-ColorOutput "Create or restore linkedin-core/shared/logs/activity-scan-results-template.csv first." -Color Warning
    exit 1
}
