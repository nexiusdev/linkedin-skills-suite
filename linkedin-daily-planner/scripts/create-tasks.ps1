...
$action1 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\00-daily-planner.ps1'
...
$action2 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\01-morning-block.ps1'
...
$action3 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\02-content-block.ps1'
...
$action4 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\03-midday-block.ps1'
...
$action5 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\04-afternoon-block.ps1'
...
$action6 = New-ScheduledTaskAction -Execute 'PowerShell.exe' -Argument '-ExecutionPolicy Bypass -WindowStyle Hidden -File C:\Users\melve\.claude\skills\linkedin-daily-planner\scripts\05-evening-block.ps1'
