...
$prospects = @(
    ...
    @{Row=73; Name="Melvern Chia"; Username="melvernchia"},
...
Write-ColorOutput "Checklist location: C:\Users\melve\.claude\skills\shared\logs\activity-scan-batch-30jan.md" -Color Info
